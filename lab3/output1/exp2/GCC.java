...
public class GCC {
	...
	public static class Map_One extends Mapper<LongWritable, Text, IntWritable, IntWritable> {
		...
		public void map(LongWritable key, Text value, Context context)
			...
			context.write(new IntWritable(Integer.parseInt(vals[0])), new IntWritable(Integer.parseInt(vals[1])));
			context.write(new IntWritable(Integer.parseInt(vals[1])), new IntWritable(Integer.parseInt(vals[0])));	
	...
	public static class Reduce_One extends Reducer<IntWritable, IntWritable, IntWritable, Text> {
		...
		public void reduce(IntWritable key, Iterable<IntWritable> values, Context context)
			...
			String neighbors = "";
			for(IntWritable neighbor : values)
			{
	...
	public static class Map_Two extends Mapper<LongWritable, Text, IntWritable, Text> {
		...
		public void map(LongWritable key, Text value, Context context)
			...
			{
				context.write(new IntWritable(Integer.parseInt(vals[i])), value);
			}
	...
	public static class Reduce_Two extends Reducer<IntWritable, IntWritable, IntWritable, IntWritable> {
		...
		public void reduce(IntWritable key, Iterable<IntWritable> values, Context context) 
			...
			for(Text neighborList : vals)
			{
				String[] split = neighborList.toString().split("[\\s]+");
